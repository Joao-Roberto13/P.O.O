...
public class VisualizarPremium extends JFrame
{
	private JScrollPane scrl;
	private String titulos[] = {"Codigo", "Nome", "Data de Inscrição", "Idade", "Peso","Sexo","Objectivo","Dias",
			"Personal Trainer","Valor a Pagar"};
	private String [][] tabDados;
	private Container contain;
	private JTable table;
	private DecimalFormat df;
	
	public VisualizarPremium(Vector vetor)
	{
		setTitle("Sócio Premium");
	...
	{
		String [][] x = new String[Premium.contP][titulos.length];//tera o numero de linhas que a quantidade no contador... 
		Premium g;
		Socio s;
		int cont = 0;
		...
		for(int i = 0; i<vetor.size(); i++)
		{
			...
			if(s instanceof Premium)
			{
				...
				x[cont][8] = g.getNomePersonalTrainer();
